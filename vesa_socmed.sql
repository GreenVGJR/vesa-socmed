...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 08, 2024 at 07:39 PM
...
CREATE TABLE `foto` (
  ...
  `TanggalUnggah` date DEFAULT current_timestamp(),
...
CREATE TABLE `komentarfoto` (
  ...
  `TanggalKomentar` date DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `likefoto` (
  ...
  `FotoID` int(11) DEFAULT NULL,
  `UserID` int(11) DEFAULT NULL,
  `TanggalLike` date DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
('LlEnqhuTItLZ0ZKjpggztuk2dCJOnqdBU21NQTUf', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', '', 1725817126);
